...
// CODE HERE
const postTaxPrices = prices.map(ele => ele * 1.07);
...
// CODE HERE
const totalPopulation  = populations.reduce((runningTotal, reducedValue) => runningTotal + reducedValue);
...
// CODE HERE
const orderTotals = orders.map(ele => ele.price + (ele.price * ele.tax));
...
const sumBobsTotal = purchases
  ...
  .reduce((runningTotal,current) => runningTotal+current.price, 0)
