...
// CODE HERE 
const contains = (arr, nam, cb) => cb(arr.includes(nam));
...
// CODE HERE 
const getUserById = (users, id, cb) => users.forEach(ele => ele.id === id? cb(ele):null );
